          ...
          {value?.map(({ file, progress }, index) => (
            ...
            >
              ...
              {typeof progress === 'number' && (
                <div className="absolute top-0 left-0 flex items-center justify-center w-full h-full bg-black rounded-md bg-opacity-70">
              ...
              {imageUrls[index] && !disabled && progress === 'PENDING' && (
                <div
                  className="absolute top-0 right-0 transform group -translate-y-1/4 translate-x-1/4"
                  onClick={(e) => {
                    e.stopPropagation();
                    void onChange?.(value.filter((_, i) => i !== index) ?? []);
                  }}
                >
                  <div className="flex items-center justify-center w-5 h-5 transition-all duration-300 bg-white border border-gray-500 border-solid rounded-md cursor-pointer hover:h-6 hover:w-6 dark:border-gray-400 dark:bg-black">
                    <X
          ...
          {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400">drop to upload</div>
                {/* <div className="mt-3">
